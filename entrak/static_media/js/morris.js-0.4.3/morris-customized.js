(function() {
  ...
  Morris.Donut = (function(_super) {
    ...
    Donut.prototype.defaults = {
      ...
      labelColor: '#000000', // CUSTOMIZED: no use
      labelColors: ['#000000'], // CUSTOMIZED
    ...
    Donut.prototype.redraw = function() {
      ...
      // CUSTOMIZED: change text attr
      this.text2 = this.drawEmptyDonutLabel(cx, cy-5, this.options.labelColor, 15, 600);
    ...
    Donut.prototype.select = function(idx) {
      this.fire('select', idx, this.data[idx]);
    ...
    Donut.prototype.setLabels = function(label1, label2, lbColor) {
      ...
      /* CUSTOMIZED: no need to draw text1 */
      /*
      this.text1.attr({
        text: label1,
        transform: ''
      ...
      */
      ...
      text2scale = Math.min(maxWidth / text2bbox.width, (inner/1.5) / text2bbox.height);
