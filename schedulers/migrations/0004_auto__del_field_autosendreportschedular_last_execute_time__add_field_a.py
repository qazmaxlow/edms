...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AutoSendReportSchedular.last_execute_time'
        db.delete_column(u'schedulers_autosendreportschedular', 'last_execute_time')

        # Adding field 'AutoSendReportSchedular.execute_time'
        db.add_column(u'schedulers_autosendreportschedular', 'execute_time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2015, 5, 14, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AutoSendReportSchedular.last_execute_time'
        db.add_column(u'schedulers_autosendreportschedular', 'last_execute_time',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 5, 14, 0, 0), blank=True),
                      keep_default=False)

        # Deleting field 'AutoSendReportSchedular.execute_time'
        db.delete_column(u'schedulers_autosendreportschedular', 'execute_time')
    ...
    models = {
        ...
        u'schedulers.autosendreportschedular': {
            ...
            'execute_time': ('django.db.models.fields.DateTimeField', [], {}),
