...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AutoSendReportReceiver'
        db.create_table(u'schedulers_autosendreportreceiver', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('scheduler', self.gf('django.db.models.fields.related.ForeignKey')(related_name='receivers', to=orm['schedulers.AutoSendReportSchedular'])),
            ('email', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'schedulers', ['AutoSendReportReceiver'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'AutoSendReportReceiver'
        db.delete_table(u'schedulers_autosendreportreceiver')
