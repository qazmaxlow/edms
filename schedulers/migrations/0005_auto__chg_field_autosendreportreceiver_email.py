...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AutoSendReportReceiver.email'
        db.alter_column(u'schedulers_autosendreportreceiver', 'email', self.gf('django.db.models.fields.EmailField')(max_length=75))

    def backwards(self, orm):

        # Changing field 'AutoSendReportReceiver.email'
        db.alter_column(u'schedulers_autosendreportreceiver', 'email', self.gf('django.db.models.fields.TextField')())
