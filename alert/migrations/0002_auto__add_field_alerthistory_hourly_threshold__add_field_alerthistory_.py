...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlertHistory.hourly_threshold'
        db.add_column(u'alert_alerthistory', 'hourly_threshold',
    ...
    def backwards(self, orm):
        # Deleting field 'AlertHistory.hourly_threshold'
        db.delete_column(u'alert_alerthistory', 'hourly_threshold')
    ...
    models = {
        ...
        u'alert.alerthistory': {
            ...
            'current_value': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            'diff_percent': ('django.db.models.fields.SmallIntegerField', [], {}),
            'hourly_threshold': ('django.db.models.fields.FloatField', [], {'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
