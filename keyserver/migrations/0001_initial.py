...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductKey'
        db.create_table(u'keyserver_productkey', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', to=orm['user.EntrakUser'])),
            ('activated_at', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('activated_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['user.EntrakUser'])),
        ))
        db.send_create_signal(u'keyserver', ['ProductKey'])


    def backwards(self, orm):
        # Deleting model 'ProductKey'
        db.delete_table(u'keyserver_productkey')
    ...
    models = {
        ...
        u'keyserver.productkey': {
            'Meta': {'object_name': 'ProductKey'},
            'activated_at': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            'activated_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': u"orm['user.EntrakUser']"}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': u"orm['user.EntrakUser']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
