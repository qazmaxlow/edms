...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntrakUser.is_personal_account'
        db.add_column(u'user_entrakuser', 'is_personal_account',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntrakUser.is_personal_account'
        db.delete_column(u'user_entrakuser', 'is_personal_account')
