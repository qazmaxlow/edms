...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntrakUser.department'
        db.add_column(u'user_entrakuser', 'department',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'EntrakUser.language'
        db.add_column(u'user_entrakuser', 'language',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'EntrakUser.is_email_verified'
        db.add_column(u'user_entrakuser', 'is_email_verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntrakUser.department'
        db.delete_column(u'user_entrakuser', 'department')

        # Deleting field 'EntrakUser.language'
        db.delete_column(u'user_entrakuser', 'language')

        # Deleting field 'EntrakUser.is_email_verified'
        db.delete_column(u'user_entrakuser', 'is_email_verified')
    ...
    models = {
        ...
        u'user.entrakuser': {
            ...
            'language': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
