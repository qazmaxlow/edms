...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EntrakUser.device_id'
        db.add_column(u'user_entrakuser', 'device_id',
                      self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EntrakUser.device_type'
        db.add_column(u'user_entrakuser', 'device_type',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EntrakUser.device_id'
        db.delete_column(u'user_entrakuser', 'device_id')

        # Deleting field 'EntrakUser.device_type'
        db.delete_column(u'user_entrakuser', 'device_type')
