...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        db.alter_column(u'user_entrakuser', 'username', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):
        db.alter_column(u'user_entrakuser', 'username', self.gf('django.db.models.fields.CharField')(max_length=30))
