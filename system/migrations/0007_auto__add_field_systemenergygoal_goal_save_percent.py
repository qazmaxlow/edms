...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SystemEnergyGoal.goal_save_percent'
        db.add_column(u'system_systemenergygoal', 'goal_save_percent',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SystemEnergyGoal.goal_save_percent'
        db.delete_column(u'system_systemenergygoal', 'goal_save_percent')
    ...
    models = {
        ...
        u'system.systemenergygoal': {
            ...
            'goal_save_percent': ('django.db.models.fields.FloatField', [], {}),
