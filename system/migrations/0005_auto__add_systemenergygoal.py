...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SystemEnergyGoal'
        db.create_table(u'system_systemenergygoal', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('system', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['system.System'])),
            ('validated_date', self.gf('django.db.models.fields.DateTimeField')()),
            ('comparison_type', self.gf('django.db.models.fields.IntegerField')()),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['user.EntrakUser'])),
            ('created_time', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'system', ['SystemEnergyGoal'])


    def backwards(self, orm):
        # Deleting model 'SystemEnergyGoal'
        db.delete_table(u'system_systemenergygoal')
